...
public class InterfazNetBeans extends javax.swing.JFrame {

    public InterfazNetBeans() {
        initComponents();           
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazNetBeans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazNetBeans().setVisible(true);
            }
        });
    }
